        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    <a class="<?php echo ($activeMenu=='dashboard')?'active':'';?>" href="index.php"><img src="assets/images/logo.png" width="10%" alt="logo"/>&nbsp;<h3 style="display:inline-block; color:#191919;"><b>TUP Online Inquiry</b></h3></a>
                </div>
