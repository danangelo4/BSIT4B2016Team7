  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
		<div class="row">
			<div class="col-sm-12">
					<a class="btn btn-success btn-md pull-left" href="admin.php?action=addsuperadmin">Add Admin</a>
							...
							<div class="table-responsive">
								<table id="admins" class="table table-bordered table-hover">
									...
									if( isset($SuperAdmins) && count($SuperAdmins)>0 ){
										foreach($SuperAdmins as $SuperAdmins){
											echo '
												<tr class="text-center clickable" id="'.$SuperAdmins['id'].'">
													<td><small>'.$SuperAdmins['username'].'</small></td>
													<td><small>'.$SuperAdmins['email'].'</small></td>
													<td><small>'.$SuperAdmins['first_name'].' '.$SuperAdmins['last_name'].'</small></td>
...
$(document).ready(function(){
	...
	$(".btnEdit").click(function(){
       if(ID!=""){
    		window.location = 'admin.php?action=edit_super_admin&id=' + ID;
